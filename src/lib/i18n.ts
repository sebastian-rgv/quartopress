...
const en = {
  ...
  toastDownloadingPdf: "Generating PDF…",
  ...
  pasteDropOverlay: "Drop your .qmd or .md here",
  toastSampleLoaded: "Sample document loaded",
  toastFileLoaded: "{name} loaded into the editor",
...
const es = {
  ...
  toastDownloadingPdf: "Generando PDF…",
  ...
  pasteDropOverlay: "Suelta tu .qmd o .md aquí",
